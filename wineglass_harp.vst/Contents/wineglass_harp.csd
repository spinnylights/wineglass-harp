<Cabbage>
form size(380, 160), caption("Wineglass Harp"), pluginID("plu1")
keyboard bounds(12, 6, 360, 100)
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
-n -d -+rtmidi=NULL -M0 --midi-key=4 --midi-velocity=5
;-odac
...
; ==============================================
<CsScore>
; uncomment and use -odac or -o flags in <CsOptions> to hear demo
;t 0 120
;a 0 0 15
;i1    15.0000     6  69  80
;i1    15.5000     6  76  80
